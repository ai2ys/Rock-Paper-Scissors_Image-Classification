...
class Processing():
    ...
    # def normalize_image_0_1_to_m1_p1(image, label):
    #     normalizer = preprocessing.Rescaling(2., offset=-1)
    ...
    def preprocess(self, ds, target_size = (224, 224), augment=True):
        ds_preproc = ds.map(
    ...
    def prepare_for_training(
        ...
        if shuffle:
            ds_prepared = ds_prepared.shuffle(len(ds), seed=42)
